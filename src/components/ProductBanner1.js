    ...
    return (
        <div className="productBanner1 row">
            <div className="productBanner1-text col-md-6 px-lg-5">
                <p className=" banner1-title px-lg-5 px-0 ">Kosset Sanitary Pads</p>
                <p className="px-lg-5 px-0"> made of cotton and organic polymer, making them a better alternative for You and the Earth.

    ...
    return (
        <div className="productBanner1 row" id="ProductBanner1">
            <div className="productBanner1-text col-md-6 px-lg-5">
                <p className="px-lg-5 px-4 py-5 py-md-4 pb-md-0 mb-0">Kosset Sanitary Pads are made of cotton and organic polymer, making them a better alternative for You and the Earth.<br/>
